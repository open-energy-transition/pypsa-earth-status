...
project = "PyPSA-Earth-Status"
author = "PyPSA-Earth-Status developers"
...
# documentation.
html_theme_options = {
    "repository_url": "https://github.com/pypsa-meets-earth/pypsa-earth-status",
...
html_short_title = "PyPSA-Earth-Status"
